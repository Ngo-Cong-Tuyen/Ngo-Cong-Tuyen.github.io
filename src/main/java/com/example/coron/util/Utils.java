...
public class Utils {
    ...
    public static String renderRoles(List<String> roles){
    ...
    public static String subTotal(List<CartInfo> carts){
        int sum =0;
        for (CartInfo cart: carts){
            sum += cart.getPrice();
        }
    ...
    public static String total(List<CartInfo> carts){
        int sum =0;
        for (CartInfo cart: carts){
            sum += cart.getPrice();
        }
    ...
    public static String totalFee(List<CartInfo> carts, int shipFee){
        String cartInfo;
        int sum =0;
        for (CartInfo cart: carts){
            sum += cart.getPrice();
